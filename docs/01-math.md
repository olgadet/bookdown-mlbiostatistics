...
## Mathematical notations, sets, functions, exponents and logarithms

This section contains some basic important notations and conventions used in mathematics and statistics. 
...
- **Rreciprocal** of any number is found by diving 1 by the number, e.g. reciprocal of 5 is $\frac{1}{5}$
...
### Variables, constants and symbols
Mathematics gives us a precise language to communiate different concepts and ideas. To be able to use it it is essential to learn symbols and understand how they are used to represent physical quantities as well as understand the rules and conventions that have been developed to manipulate them. 
